...
import { ISharedMemory } from "./home"
...
interface IAppsTableRowProps extends StyledComponentProps {
  connectionsData:ISharedMemory[];
}

const SharedMemoryChartComponent = ({
classes = {},
connectionsData,
}: IAppsTableRowProps) => {
...
const SharedMemoryChart = withStyles(style)(
  withTheme(SharedMemoryChartComponent)
);
export { SharedMemoryChart };